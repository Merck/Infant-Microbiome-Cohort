...
# Add columns to abx frame with fixed names, routes and age when abx were taken
...
# build out dataframe with abx info per sample
abx_rows = dict()
...
per_sample_abx.to_csv('../../data/metadata/nasal/nasal_abx_usage.csv', index_label='SampleID')
